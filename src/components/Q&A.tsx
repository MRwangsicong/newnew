...
const dummyAnswer = `1. Please check the official address
Find our official website and download it locally
2. How do I log in after downloading?
Invite code: Invite users to use and get transaction rewards
Proxy port: Please fill in the HTTP interface of VPN
Login Account`;
